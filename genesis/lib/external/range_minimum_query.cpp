/**
 * @brief Implementation of the Range Minimum Query class.
 *
 * See the class declaration in `rarnge_minimum_query.hpp` in this directory for important remarks
 * on the licence of this code!
 *
 * @file
 * @ingroup utils
 */

#include "external/range_minimum_query.hpp"
 ...
 */
const char RangeMinimumQuery::log_table_256_[256] =
{
 ...
 */
const char RangeMinimumQuery::lsb_table_256_[256] =
{
